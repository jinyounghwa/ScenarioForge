...
export default function CharacterStats({ stats, characterSceneMap }: Props) {
  ...
  return (
    <div>
      <div className="grid grid-cols-12 gap-2 px-4 py-2 border-b border-gray-100 dark:border-gray-700 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">
      ...
      <div className="divide-y divide-gray-50 dark:divide-gray-800">
        {sorted.map((s) => (
          <div
            key={s.characterId}
            className="grid grid-cols-12 gap-2 items-center px-4 py-3 hover:bg-gray-50/60 dark:hover:bg-slate-800/60 transition rounded-lg"
          >
            ...
            <div className="col-span-4">
              <div className="h-2.5 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.max(
                      (s.mentionCount / max) * 100,
                      s.mentionCount > 0 ? 6 : 0,
                    )}%`,
